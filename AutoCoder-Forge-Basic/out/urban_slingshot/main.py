    ...
    def draw(self, screen):
        ...
        if self.pull_start:
            pygame.draw.line(
                ...
                WHITE,
                self.pos,
                (self.pos[0] + self.pull_vector[0], self.pos[1] + self.pull_vector[1]),
                3,
            )
...
def main():
    ...
    while running:
                ...
                if event.button == 1:
                    ...
                    if projectiles_left > 0:
                        projectile = Projectile(
                            slingshot.pos[0], slingshot.pos[1], vel_x, vel_y
                        )
        ...
        pygame.draw.rect(
            screen, DARK_GRAY, (0, SCREEN_HEIGHT - 100, SCREEN_WIDTH, 100)
        )  # Ground
        for i in range(5):
            pygame.draw.rect(
                screen,
                GRAY,
                (i * 150 + 50, SCREEN_HEIGHT - 200 - i * 50, 100, 200 + i * 50),
            )  # Buildings
